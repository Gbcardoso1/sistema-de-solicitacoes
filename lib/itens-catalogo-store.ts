...
const CRECHE_NOMES = [
  ...
  "BERCO PORTATIL (CHIQUEIRINHO) 130CM X 73CM",
  "CADEIRA PLASTICA INFANTIL BAMBINI",
  "CADEIRA PRE ESCOLAR INDIVIDUAL",
  "CAMA INFANTIL 135CM",
  "CAPA PARA BEBE CONFORTO 96CM X 65CM",
  "COLCHAO PARA CAMA INFANTIL",
  "COLCHONETE CASAL",
  "COLCHONETE SOLTEIRO",
  "EDREDOM 1,80M X 2,40M",
  "KIT MESA INFANTIL CONJUNTO SEXTAVADO",
  "LENCOL DE BERCO C/ ELASTICO LISO 70CM X 1,30M X 15CM UND.",
  "LENCOL DE CASAL C/ ELASTICO UND.",
  "LENCOL DE CASAL S/ ELASTICO UND.",
  "LENCOL DE SOLTEIRO C/ ELASTICO UND.",
  "LENCOL DE SOLTEIRO S/ ELASTICO UND.",
  "MANTA MICROFIBRA 2,20M X 1,80M (BRANCO)",
  "MANTA MICROFIBRA 2,20M X 1,80M (CINZA)",
  "TOALHA DE BANHO BRANCA UND.",
  "TOALHA DE BANHO C/ CAPUZ BRANCA 65CM X 80CM UND.",
